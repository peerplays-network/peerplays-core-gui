...
module.exports = {
  print_result(tr_object) {
    ...
    try {
      let tr = types.signed_transaction_type.fromObject(tr_object);
      let tr_hex = types.signed_transaction_type.toHex(tr);
  ...
  print_hex(hex) {
    ...
    try {
      let tr = types.signed_transaction_type.fromHex(hex);
      let tr_object = types.signed_transaction_type.toObject(tr);
