...
export default {
   ...
   VOTING_TOGGLE_HAS_VOTED : 'VOTING_TOGGLE_HAS_VOTED',
   VOTING_SET_WITNESS_COUNT : 'VOTING_SET_WITNESS_COUNT',
   VOTING_SET_COMMITTEE_COUNT : 'VOTING_SET_COMMITTEE_COUNT',
   VOTING_SET_SON_COUNT : 'VOTING_SET_SON_COUNT',
   VOTING_RESET_VOTED_COUNTS : 'VOTING_RESET_VOTED_COUNTS',
