...
class ChainStore
{
    ...
    */
   getUpcomingTournaments( account_id )
   {
      let current = this.tournaments_by_account.get( account_id );
      if( current === undefined )
         this.fetchUpcomingTournaments(account_id);
      return this.tournaments_by_account.get( account_id );
   }
