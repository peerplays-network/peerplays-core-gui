...
class ChainStore
{
   ...
   getUpcomingTournaments( account_id )
   {
      ...
      if( current === undefined )
      {
          this.tournaments_by_account = this.tournaments_by_account.set( account_id, Immutable.List() )
          Apis.instance().db_api().exec( "get_upcoming_tournaments", [ account_id, 100 ] )
              .then( tournaments => {
                         ...
                         this.tournaments_by_account = this.tournaments_by_account.set( account_id, Immutable.List(list) )
                         this.notifySubscribers()
                     },
                     error => {
