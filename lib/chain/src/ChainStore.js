...
class ChainStore {
   ...
   fetchRecentHistory(account, limit = 100) {
    ...
    getBinnedOrderBook( betting_market_id, precision ) {
        return new Promise( (resolve, reject ) => {
            Apis.instance().db_api().exec( "get_binned_order_book", [ account_id, precision ] )
    ...
    getTotalMatchedBetAmountForBettingMarketGroup( group_id ) {
        return new Promise( (resolve, reject ) => {
            Apis.instance().db_api().exec( "get_total_matched_bet_amount_for_betting_market_group", [ group_id ] )
    ...
    getEventsContainingSubString( sub_string, language ) {
        return new Promise( (resolve, reject ) => {
            Apis.instance().db_api().exec( "get_events_containing_sub_string", [ sub_string, language ] )
