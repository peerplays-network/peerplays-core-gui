...
let budget_record_prefix = "1." + parseInt(impl_object_type.budget_record,10) + ".";
...
class ChainStore {
    ...
    */
    ...
    onUpdate( updated_objects )  {
        ...
        // console.log("objects in store:", this.objects_by_id.size, updated_objects[0].map(o => o && o.id || o));
