...
ChainTypes.object_type = {
    ...
    event_group: 17,
    event: 18,
    betting_market_rules: 19,
    betting_market_group: 20,
    betting_market: 21,
    bet: 22,
    tournament: 23,
    tournament_details: 24,
    match: 25,
    game: 26
};
...
ChainTypes.impl_object_type = {
    ...
    distributed_dividend_balance_data_data: 21
};
...
ChainTypes.operations = {
  ...
  bet_place: 62,
  betting_market_resolve: 63,
  betting_market_resolved: 64,
  bet_adjusted: 65,
