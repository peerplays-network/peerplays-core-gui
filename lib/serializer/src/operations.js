...
export const competitor_create_operation_fee_parameters = new Serializer( 
    "competitor_create_operation_fee_parameters",
    {fee: uint64}
);
...
export const betting_market_resolve_operation_fee_parameters = new Serializer( 
    "betting_market_resolve_operation_fee_parameters",
    {fee: uint64}
);

export const betting_market_resolved_operation_fee_parameters = new Serializer( 
    "betting_market_resolved_operation_fee_parameters"
);
...
var game_specific_details = static_variant([
    rock_paper_scissors_game_options
]);
...
var game_specific_moves = static_variant([
    rock_paper_scissors_throw_commit, rock_paper_scissors_throw_reveal
]);
...
export const competitor_create = new Serializer(
    "competitor_create",
    {fee: asset,
    name: map((string), (string)),
...
export const event_create = new Serializer(
    ...
    competitors: array(object_id_type),
    extensions: set(future_extensions)}
);

export const moneyline_market_options = new Serializer(
    "moneyline_market_options"
);

export const spread_market_options = new Serializer(
    "spread_market_options",
    {margin: int32}
);

export const over_under_market_options = new Serializer(
    "over_under_market_options",
    {score: uint32}
);

export const betting_market_options_type = static_variant([
    moneyline_market_options,
    spread_market_options,
    over_under_market_options
]);
...
export const betting_market_group_create = new Serializer(
    ...
    options: betting_market_options_type,
    extensions: set(future_extensions)}
);
...
export const bet_place = new Serializer(
    ...
    amount_reserved_for_fees: int64,
...
export const betting_market_resolve = new Serializer(
    "betting_market_resolve",
    {fee: asset,
    betting_market_id: protocol_id_type("betting_market"),
    resolution: betting_market_resolution_type,
    extensions: set(future_extensions)}
);

export const betting_market_resolved = new Serializer(
    "betting_market_resolved",
    {bettor_id: protocol_id_type("account"),
    betting_market_id: protocol_id_type("betting_market"),
    resolution: betting_market_resolution_type,
    winnings: asset,
...
new Serializer( 
    "competitor",
    {id: protocol_id_type("competitor"),
    name: map ((string), (string)),
...
new Serializer( 
    ...
    competitors: array(protocol_id_type("competitor")),
    status: event_status,
    scores: array(string)}
);
...
new Serializer( 
    ...
    options: betting_market_options}
);
