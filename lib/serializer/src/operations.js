...
var fba_distribute_operation_fee_parameters = new Serializer( 
    "fba_distribute_operation_fee_parameters",
    {}
);

var tournament_create_operation_fee_parameters = new Serializer( 
    "tournament_create_operation_fee_parameters",
    {fee: uint64,
    price_per_kbyte: uint32}
);

var tournament_join_operation_fee_parameters = new Serializer( 
...
var fba_distribute = new Serializer(
    "fba_distribute", 
    {fee: asset,
    account_id: protocol_id_type("account"),
...
var dividend_asset_options = new Serializer(
...
var asset_update_dividend = new Serializer(
...
var rock_paper_scissors_game_options = new Serializer(
...
var tournament_options = new Serializer( 
    "tournament_options",
    {
    type_of_game: uint16,
...
var tournament_create = new Serializer( 
    "tournament_create",
    {fee: asset,
    creator: protocol_id_type("account"),
...
var tournament_join = new Serializer( 
    "tournament_join",
    {fee: asset,
